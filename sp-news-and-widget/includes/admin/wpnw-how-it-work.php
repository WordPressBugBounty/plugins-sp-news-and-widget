					...
					<div class="meta-box-sortables">
						<div class="postbox wpos-pro-box">
							...
							<div class="inside">
								...
								<a class="button button-primary wpos-button-full button-orange" href="<?php echo esc_url(WPNW_PLUGIN_LINK_UNLOCK); ?>" target="_blank"><?php esc_html_e('Upgrade To PRO', 'sp-news-and-widget'); ?></a>
							</div><!-- .inside -->
						</div><!-- #general -->
					</div><!-- .meta-box-sortables -->
